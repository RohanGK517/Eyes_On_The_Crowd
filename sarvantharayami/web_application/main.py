...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root@localhost/rgk'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 465
app.config['MAIL_USERNAME'] = 'gkrohan53@gmail.com'
app.config['MAIL_PASSWORD'] = "mldnqfwpzhvakzgn"
    ...
    if request.method == "POST" and "otp" not in session:
        ...
        if duplicate:
            ...
            user_register = User(firstName=user_firstname, secondName=user_secondname, email=user_email, phone=user_phone,
                                 password=user_password, UserID=user_ID, addharID=user_addhar, profile_path=profile_path, catagory=catagory,verify=-1)
...
def forgot_pw():
    if request.method == "POST":
        ...
        if User.query.filter_by(email=email):
            ...
            msg = Message('forgot password OTP', body=body, sender='gkrohan53@gmail.com',
                          recipients=[email])
